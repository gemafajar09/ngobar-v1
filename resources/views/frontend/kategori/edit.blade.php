...
@section('content')
    <div class="flex justify-center my-8">
        <div class="max-w-xl w-full border border-grey-300 rounded-lg shadow p-4">
            <h1 class="text-slate-800 text-xl text-center font-semibold">Halaman Edit Kategori</h1>
            <form action="{{ route('update-kategori', $kategori->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="my-4">
                    ...
                    <input type="text"
                        ...
                        placeholder="Masukkan Nama Kategori" name="nama_kategori" value="{{ $kategori->nama_kategori }}">
